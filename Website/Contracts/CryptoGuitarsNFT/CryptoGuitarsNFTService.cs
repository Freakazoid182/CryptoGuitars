...
using CryptoGuitars.Contracts.CryptoGuitarsNFT.ContractDefinition;

namespace CryptoGuitars.Contracts.CryptoGuitarsNFT
{
    public partial class CryptoGuitarsNFTService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, CryptoGuitarsNFTDeployment cryptoGuitarsNFTDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<CryptoGuitarsNFTDeployment>().SendRequestAndWaitForReceiptAsync(cryptoGuitarsNFTDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, CryptoGuitarsNFTDeployment cryptoGuitarsNFTDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<CryptoGuitarsNFTDeployment>().SendRequestAsync(cryptoGuitarsNFTDeployment);
        }

        public static async Task<CryptoGuitarsNFTService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, CryptoGuitarsNFTDeployment cryptoGuitarsNFTDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, cryptoGuitarsNFTDeployment, cancellationTokenSource);
            return new CryptoGuitarsNFTService(web3, receipt.ContractAddress);
        }
        ...
        public CryptoGuitarsNFTService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
